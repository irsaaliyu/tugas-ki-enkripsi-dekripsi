...
const Footer = () => {
  return (
    <section className="py-12 bg-gradient-to-r from-fuchsia-400 to-blue-400">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
            <div className="xl:flex xl:items-center xl:justify-start">
                <p className="mt-5 text-sm text-white xl:ml-6 xl:mt-0">© Copyright 2024 Irsalina Yumna</p>
            </div>
            ...
            <div className="items-center mt-8 xl:mt-0 xl:flex xl:justify-end xl:space-x-8">
                ...
                <ul className="flex items-center justify-center space-x-8 xl:justify-end">
                    ...
                    <li>
                        <a href="https://www.facebook.com/share/a5Cs8PNpbW2FsfPQ/?mibextid=qi2Omg" title="" className="block text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">
                    ...
                    <li>
                        <a href="https://www.instagram.com/irsly_?igsh=MW8xdjU4aWR6d3AwNQ==" title="" className="block text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">
                            <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
